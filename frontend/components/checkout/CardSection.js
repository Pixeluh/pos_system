...
function CardSection(props) {
  return (
    <div>
      <div>
        <label htmlFor="card-element">Credit / Debit </label>
        <div>
        ...
        <label>Swipe / Insert Card</label>
        <div className="order-button-wrapper">
                <button onClick={props.submitOrder}>Use Machine</button>
              </div>
        <label>Pay With Cash </label>
        <div className="order-button-wrapper">
                <button onClick={props.submitOrder}>Open Register</button>
              </div>
      </div>
      <style jsx>
        {`
